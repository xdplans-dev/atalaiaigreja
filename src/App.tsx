...
import { 
  Menu, X, Cross, Church, Calendar, PlayCircle, Heart, Users, Image as ImageIcon, CreditCard, Phone, 
    ...
    <div className="flex flex-col min-h-screen bg-church-black selection:bg-church-gold selection:text-white relative overflow-hidden">
      ...
      <nav 
        className={cn(
          ...
          isScrolled ? "bg-church-black/80 backdrop-blur-xl py-4 border-b border-white/10" : "bg-transparent py-8"
        )}
      >
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full mb-6">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.2em] text-white/70">Estamos Online • Próximo Culto: Hoje 19:30</span>
                </div>
                ...
                <p className="text-white/60 max-w-lg text-lg mb-10 font-light leading-relaxed">
                  {CHURCH_DATA.purpose}
                </p>
        ...
        {/* Biblical Verse */}
        <section className="py-24 bg-church-black relative border-y border-white/5">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <Quote className="w-12 h-12 text-church-gold/20 mx-auto mb-8" />
            <motion.h2 
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              className="text-2xl md:text-4xl font-serif italic text-white/90 leading-relaxed mb-6"
            >
              &ldquo;Lâmpada para os meus pés é tua palavra, e luz para o meu caminho.&rdquo;
            </motion.h2>
            <p className="text-church-gold font-bold tracking-widest uppercase text-xs">Salmos 119:105</p>
          </div>
        </section>

        {/* About Us Section */}
        <section id="about" className="py-32 bg-church-black relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div>
                ...
                <h2 className="text-4xl md:text-6xl font-serif font-bold text-white mb-8">Vivendo o <span className="italic text-church-gold">Propósito</span></h2>
        ...
        {/* Schedule Section */}
        <section id="services" className="py-32 bg-neutral-900/40 relative border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              <span className="text-church-gold font-bold tracking-widest uppercase text-xs mb-4 block">Agenda Semanal</span>
              <h2 className="text-4xl md:text-6xl font-serif font-bold text-white">Momentos de <span className="italic text-church-gold">Adoração</span></h2>
            </div>
      ...
      {/* Footer */}
      <footer className="relative z-20 h-auto lg:h-20 bg-black flex flex-col lg:flex-row items-center justify-between px-10 py-6 lg:py-0 border-t border-white/5 gap-6">
        <div className="flex flex-col lg:flex-row gap-6 text-[10px] text-white/40 uppercase tracking-widest text-center lg:text-left">
          <div className="flex items-center gap-2 justify-center lg:justify-start">
            <span className="text-church-gold font-bold">Sede:</span> {CHURCH_DATA.addresses.sede.street}
          </div>
          <div className="flex items-center gap-2 justify-center lg:justify-start">
            <span className="text-church-gold font-bold">Unidade:</span> {CHURCH_DATA.addresses.unidade.street}
          </div>
        </div>
        <div className="flex flex-col lg:flex-row items-center gap-4 text-[9px] uppercase">
      ...
      <a 
        href="#"
        className="fixed bottom-8 right-8 z-[60] w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl shadow-green-500/20 hover:scale-110 transition-transform duration-300 group"
      >
        <MessageSquare className="w-8 h-8 fill-white group-hover:rotate-12 transition-transform" />
      </a>
    </div>
  );
}
